...
export interface ChoiceCard {
  ...
  targetRoomId: string;
  /** Path to the POV transition video (webm only) */
...
export interface RoomNode {
  ...
  id: string;
  /** Path to the static background image (webp only) */
  staticBackground: string;
  /** Optional path to a subtle looping video instead of static image (webm only) */
...
export const worldConfig: WorldConfig = {
  ...
  rooms: {
    bank: {
      id: 'bank',
      staticBackground: '/rooms/banklobby_room.webp',
      cards: [
        {
          id: 'bank-to-vault',
          label: 'Enter Vault',
          ...
          transitionVideo: '/rooms/banklobby_to_bankvault.webm',
        },
        {
          id: 'bank-to-saloon',
    ...
    bankVault: {
      id: 'bankVault',
      staticBackground: '/rooms/bankvault_room.webp',
      cards: [
        {
